                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.all(10),
                                child: Text("Threshold Unit", style: TextStyle(
                                  fontSize: 25,
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.all(10),
                                padding: EdgeInsets.all(10),
                                child: Text("This months Total Power Consumption has been ${netpower.ceilToDouble() } (KWH/UT). Please Select when do you want to get reminder about the power usage.", style: TextStyle(
                                  fontSize: 20,
                              ...
                              Container(
                                ...
                                padding: EdgeInsets.all(10),
                                child: Center(
                                  child: Text("Power Value - $BillRate  KWH", style: TextStyle(
                                    fontSize: 25,
                                    fontWeight: FontWeight.bold,
                                    decoration: TextDecoration.underline,
                                  ),),
                                  ...
                                  child: InkWell(
                                    onTap: (){
                                      ...
                                      final snackBar = SnackBar(
                                        content: Text('Reminder has been Set Successfully!'),
                                        backgroundColor:  Color(0xff009093),
                                    ...
                                    child: Center(
                                      child: Container(
                                          ...
                                          margin: EdgeInsets.all(10),
                                          padding: EdgeInsets.all(10),
                                          child: Text("Set Reminder", style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 20
                                          ),)),
                                    ),
